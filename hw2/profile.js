...
window.onload = function() {
    ...
    updateBtn.onclick = function(){
        var name = document.getElementById("disname").innerHTML;
        ...
        if(result){
            ...
            document.getElementById("disnameField").innerHTML = name;
            document.getElementById("emailField").innerHTML = email;
            document.getElementById("phoneField").innerHTML = phone;
            document.getElementById("zipcodeField").innerHTML = zipcode;
